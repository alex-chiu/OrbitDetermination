function [dY] = state_prop_no_c_d(time, Y, t0_UTC, getAMat, getAcc)
% full_prop_no_c_d : Full propagation function with constant drag
% coefficient
%
% INPUTS
%
...
% Find acceleration
A_ECI = getAcc(V_ECI(1), V_ECI(2), V_ECI(3), R_ECI(1), R_ECI(2), R_ECI(3));
...
A = getAMat(V_ECI(1), V_ECI(2), V_ECI(3), R_ECI(1), R_ECI(2), R_ECI(3));
dPhi = A * Phi;
